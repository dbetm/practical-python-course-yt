# Curso práctico (intermedio) de Python
...
3. [Imagen a mosaico](./sunset-mosaic/): Crea un mosaico compuesto con mini fotos de atardeceres.
4. [Trazas de estrellas](./star-trails/): Crea un timelapse de trazas de estrellas con fotos reales.
